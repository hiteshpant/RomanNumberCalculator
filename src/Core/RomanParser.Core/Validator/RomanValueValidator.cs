...
namespace RomanParser.Core
{
    ...
    {
        // M{0,3}
        //specifies the thousands section and basically restrains it to between 0 and 3999 
        ...
        public bool IsValid(string input)
        {
            ...
            return rg.IsMatch(input.ToUpper()) ? true : throw new InValidRomanValueException("Invalid Roman Sequence, " +
                                                    "I, X or C you cannot have more than three occurance and V, L or D cannot" +
                                                    " have more than one occurence"+  " Please try with correct format");
        }
    }
}
